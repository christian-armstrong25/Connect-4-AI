...
function checkExpectListAlpha(actual, expected, message) {
  if (Caml_obj.caml_equal(actual, expected)) {
    return printGreen("ceSuccess: " + message);
  } else {
    printRed("ceFail: " + message);
    printRed("expected output: ");
    console.log($$Array.of_list(expected));
    printRed("actual output: ");
    console.log($$Array.of_list(actual));
    return ;
  }
}

function checkExpectListListAlpha(actual, expected, message) {
  if (Caml_obj.caml_equal(actual, expected)) {
    return printGreen("ceSuccess: " + message);
  } else {
    printRed("ceFail: " + message);
    printRed("expected output: ");
    console.log($$Array.of_list(List.map($$Array.of_list, expected)));
    printRed("actual output: ");
    console.log($$Array.of_list(List.map($$Array.of_list, actual)));
    return ;
  }
}
...
exports.checkExpectListAlpha = checkExpectListAlpha;
exports.checkExpectListListAlpha = checkExpectListListAlpha;
